...
<body>
  <header class="header">
    ...
    <div>
        ...
        <nav>
           <ul class="nav-links">
                  <li> <a href="Main.php" class="a">inicio</a></li>
    ...
    <div class="cartulina">
      <div class="eslogan">
        ...
        <button href="Login.html"type="submit" class="btn btn-primary">login</button>
      ...
      <div class="sing">
        <div>
         ...
         <form action="controller/loginauth.php" method="post">
          <div class="botones">
                     <!--formulario-->
            <input type="text" name="nombre" class="doble" placeholder="Nombre">
            <input type="password" name="contraseña" class="doble" placeholder="Contraseña">
            <input type="text" name="direccion" class="doble" placeholder="Dirección">
            <input type="text" name="identificacion" class="doble" placeholder="Identificación">
          </div>
          <!--boton de enviar-->
